    ...
    <header className="sticky top-0 z-50 w-full bg-white shadow-sm">
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex gap-4">
            <span className="flex items-center gap-1">
              <MapPin className="w-3 h-3" /> Pilih Lokasi Toko: <strong className="cursor-pointer hover:underline">Klipang Grosir Semarang</strong>
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="md:hidden p-3 bg-white border-b border-gray-100">
        <div className="relative">
          ...
          <Input placeholder="Cari di Klipang Grosir" className="pl-9 h-10 bg-gray-50 border-none rounded-full" />
        </div>
      </div>
    </header>
  );
